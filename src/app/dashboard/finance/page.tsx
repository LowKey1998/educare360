          ...
          <TabsContent value="overview" className="p-5 mt-0 outline-none">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-xs text-gray-400 italic">Syncing financial records...</p>
              </div>
            ) : (
                    ...
                    <div className="h-[250px] w-full">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={collectionData}>
                          ...
                          <Bar dataKey="Collected" fill="#0D9488" radius={[4, 4, 0, 0]} barSize={14} />
                          <Bar dataKey="Target" fill="#E5E7EB" radius={[4, 4, 0, 0]} barSize={14} />
                        </BarChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      <div className="h-[200px] w-full md:w-1/2">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie data={paymentMethodsData} cx="50%" cy="50%" innerRadius={50} outerRadius={75} paddingAngle={2} dataKey="value">
